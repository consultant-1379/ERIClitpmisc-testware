package com.ericsson.nms.litp.taf.test.misc.cases;
...
public class LITPMiscRunner extends TorTestCaseHelper {
    
    Logger logger = Logger.getLogger(LITPMiscRunner.class);
     ...
     * @PRIORITY HIGH
     */
    @TestId(id = "CXP9032580-1", title = "Run python test cases for Regression Suites")
    @Test(groups={"ACCEPTANCE", "CDB_REGRESSION"})
    public void runERIClitpMiscTests() {
     ...
     * @param failures
     */
    @TestId(id = "CXP9032580-2", title = "Parse xml outputs from python tests")
